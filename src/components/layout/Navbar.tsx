...
import { LayoutDashboard, ClipboardList, Users, Settings, LogOut, Activity } from 'lucide-react'
import { cn } from '@/lib/utils'

const navItems = [
  { href: '/dashboard',       label: 'Übersicht',   icon: LayoutDashboard, roles: ['ADMIN','THERAPIST','PATIENT'] },
  { href: '/admin/users',     label: 'Benutzer',    icon: Users,           roles: ['ADMIN','THERAPIST'] },
  ...
  return (
    <nav className="fixed top-0 inset-x-0 z-50 h-14 bg-white border-b border-slate-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between">
        {/* Logo */}
        <Link href="/dashboard" className="flex items-center gap-2.5 font-bold text-indigo-600">
